...
$newSunRise = $newSR[2];
$newSunSet = $newSR[5];
//sunrise after explode
echo "Sun Rise just after exlode of array:" . " " . $newSunRise . "<br>";
$newSunRise1 = hourToDecimal($newSunRise,$timezone);
echo "Sun Rise after converting into decimal from array:" . " " . $newSunRise1 . "<br>";
...
echo "<br>Tithi1 for the calculation of Karan: " . " " . $tithi1 . "<br>";
/*
$tithi_karan = $tithi1;
$tithi_ik = floor($tithi_karan);
$tithi_fractk = $tithi_karan - $tithi_ik;
...
$karan_number = $karan1;//call of karan calculation function
*/
$karan_number = karan_cal($tithi1); //call of karan calculation function
echo "<br>This is karan number" . $karan_number . "<br>";
$karanTime = karan_time($tithi_karan, $speedDifference);
include 'impFiles/karanNames.php'; //nakshatraNames
echo "Ending Time :" . dtimetotime($karanTime) . "<br>";
//Calculation of Yoga
$sumSunMoonAngle = $sunAngle2 + $moonAngle2;
